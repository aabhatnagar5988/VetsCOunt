...
public class TinyDB {
     ...
     */
    public String putImage(String theFolder, String theImageName,
                           Bitmap theBitmap) {
     ...
     *
     * @param key SharedPreferences key
     *            boolean value returned if key was not found
...
//    public ArrayList<MastersWrapper> getListObject(String key, Class<?> mClass) {
//        Gson gson = new Gson();
//
//        ArrayList<String> objStrings = getListString(key);
//        ArrayList<MastersWrapper> objects = new ArrayList<MastersWrapper>();
//
//        for (String jObjString : objStrings) {
//            Object value = gson.fromJson(jObjString, mClass);
//            objects.add((MastersWrapper) value);
//        }
//        return objects;
//    }
    ...
    public void putListDouble(String key, ArrayList<Double> doubleList) {
        ...
        preferences.edit()
                .putString(key, TextUtils.join("‚‗‚", myDoubleList))
                .apply();
    }
...
//    public void putListObject(String key, ArrayList<MastersWrapper> arrayList) {
//        checkForNullKey(key);
//        Gson gson = new Gson();
